...
namespace SchedulingAppointment.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        {
            return _db.Appointments.Where(x => x.DoctorId == doctorId).ToList().Select(x => new AppointmentVM()
            {
                Id=x.Id,
        ...
        {
            return _db.Appointments.Where(x => x.PatientId == patientId).ToList().Select(x => new AppointmentVM()
            {
                Id = x.Id,
                Description = x.Description,
                StartDate = x.StartDate.ToString("yyyy-MM-dd HH:mm:ss"),
